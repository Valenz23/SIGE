...
output:
    html_document: 
      ...
      code_folding: show
runtime: shiny
nota: Se ha comentado cierta funcionalidad debido a que la biblioteca funModeling ha sido deprecada y no se sigue manteniendo. Queda como ejercicio opcional reemplazar la funcionalidad por otras bibliotecas alternativas en mantenimiento.
---
...
```{r leer-datos}
training_data_raw <- read_csv2("diabetes.csv", na = "-999")
...
```{r status}
#status <- df_status(training_data).  #old: funModelling
```
...
# old functionality deprecated from funModelling
# inputPanel(
